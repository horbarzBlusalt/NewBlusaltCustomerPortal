...
WebUI.click(findTestObject('Object Repository/Page_BluSalt/li_PNIN'))

WebUI.click(findTestObject('Object Repository/Page_BluSalt/button_Verify NIN'))

WebUI.click(findTestObject('Object Repository/Page_BluSalt/small_Phone Number is required'))

WebUI.click(findTestObject('Object Repository/Page_BluSalt/small_Application is required'))

WebUI.setText(findTestObject('Object Repository/Page_BluSalt/input__phone_number'), '0817 533 2522')
...
WebUI.verifyTextPresent('NIN not found', false)
...
WebUI.verifyTextPresent('NIN Verification Completed Successfully', false)
