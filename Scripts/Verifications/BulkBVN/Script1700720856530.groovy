...
WebUI.click(findTestObject('Object Repository/Page_BluSalt/li_Bulk BVN'))

WebUI.click(findTestObject('Object Repository/Page_BluSalt/button_Verify BVN'))

WebUI.click(findTestObject('Object Repository/Page_BluSalt/small_BVN File is required'))
...
WebUI.click(findTestObject('Object Repository/Page_BluSalt/p_Your file is Successfully Uploaded'))

WebUI.click(findTestObject('Object Repository/Page_BluSalt/p_Successful'))
