...
try {
    ...
    WebUI.click(findTestObject('Object Repository/Page_BluSalt/div_NGN_2'))
} 

WebUI.click(findTestObject('Object Repository/Page_BluSalt/button_Verify BVN'))

WebUI.verifyTextPresent('No Result Found For This Bvn', false)

WebUI.setText(findTestObject('Object Repository/Page_BluSalt/input_BVN_bvn_number'), '22372706052')

WebUI.click(findTestObject('Object Repository/Page_BluSalt/button_Verify BVN'))

WebUI.verifyTextPresent('Obaloluwa Peter Abioye', false)

WebUI.verifyTextPresent('BVN Verification Completed Successfully', false)
